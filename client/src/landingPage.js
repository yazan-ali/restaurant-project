            ...
            <div className={classes.root}>
              ...
              <div className="row mt-3 pb-5">
                 ...
                 <div className={`card ${classes.card}`} >
                   ...
                   <p className="card-text">Our pizzas are wood oven baked using only the freshest ingredients, homemade pasta sauce and fresh dough made daily.</p>
                   </div>
                </div>
                 </div>
                 <div className="col-md-4">
                 <div className={`card ${classes.card}`} >
                   ...
                   <p className="card-text">With our portable wood oven, we can cater any event, whether it be a private party or social gathering. And with our two cars, we offer an efficient delivery service.</p>
                   </div>
                </div>
                 </div>
              </div>
