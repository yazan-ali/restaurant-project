...
class BeefPizzaList extends Component{
  ...
  componentDidMount(){
    axios.get('hhttps://limitless-beyond-06124.herokuapp.com/pizza-house/pizza/type/beef')
    .then(res => {
        ...
        return(
          <>
           ...
           <div>
            ...
            {this.state.beefPizza.map( (pizza) => (
                <Card
                id={pizza._id}
                 img={pizza.pizza_img} 
...
export default withStyles(styles)(BeefPizzaList);